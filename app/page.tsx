    ...
    return (
        <main className="flex-1">
            ...
            <section id="skills" className="w-full py-12 md:py-24 lg:py-32 bg-muted/40 border-t">
                <div className="container px-4 md:px-6 mx-auto">
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-center mb-12 text-primary">Skills
                        & Expertise</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <Card className="flex flex-col">
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground text-center">
                                    Deep Learning, LLMs (Large Language Models), AI Agents, Natural Language Processing
                                    (NLP), Computer Vision basics. 7+ years experience building and deploying AI
                                    solutions.
                                </p>
                        ...
                        <Card className="flex flex-col">
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground text-center">
                                    Building complete web applications with modern stacks. Proficient in React, Next.js,
                                    TypeScript, Node.js, Python (Flask/Django), Tailwind CSS, SQL/NoSQL databases.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="flex flex-col">
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground text-center">
                                    Deploying and managing applications on cloud platforms (AWS, GCP, Azure). Experience
                                    with Docker, Kubernetes basics, CI/CD pipelines (GitHub Actions/GitLab CI),
                                    Terraform.
                                </p>
                            </CardContent>
                        </Card>
                            ...
                            <Card>
                                <CardHeader className="flex flex-row items-center gap-4 space-y-0 pb-2">
                                    ...
                                    <div className="flex-1">
                                        <CardTitle className="text-base font-semibold">Carnegie Mellon University
                                            (CMU)</CardTitle>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4">
                                ...
                                <p className="text-foreground/80">Cycling - Exploring trails and roads for fitness and
                                    fun.</p>
                            </div>
                            <div className="flex items-center gap-4">
                                <Music className="w-6 h-6 text-primary flex-shrink-0"/>
                                <p className="text-foreground/80">Music Production - Creating beats and exploring sound
                                    design.</p>
                            </div>
                            <div className="flex items-center gap-4">
                                <Trophy className="w-6 h-6 text-primary flex-shrink-0"/>
                                <p className="text-foreground/80">Golfing - Enjoying the challenge and outdoors on the
                                    course.</p>
                            </div>
                        </div>
                    </div>
