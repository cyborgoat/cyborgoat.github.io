...
```mermaid
graph TD
    A["Most Companies<br/>(Persuasion Mindset)"] -->|❌ Inefficient| B["Try to convince<br/>general audience"]
    C["Successful Startups<br/>(Search Mindset)"] -->|✅ Effective| D["Find specific<br/>early adopter<br/>archetypes"]
    B --> E["High CAC<br/>Low conversion"]
    D --> F["High engagement<br/>Rich feedback"]
```
...
```mermaid
graph LR
    A["Early Adopter<br/>Target"] --> B["The Enthusiast"]
    A --> C["The User with<br/>a Burning Problem"]
    
    B --> D["🎯 Loves new tech<br/>🎯 Seeks cutting edge<br/>🎯 Motivated by novelty"]
    C --> E["🎯 Desperate to solve<br/>a specific problem<br/>🎯 Price-insensitive<br/>🎯 Ready to act now"]
    
    D --> F["Example: Gustaf<br/>Airbnb employee<br/>who enjoys discovering<br/>& introducing new tools"]
    E --> G["Example: Ankit<br/>Needed inference API<br/>quickly, no patience<br/>for setup complexity"]
```
...
```mermaid
graph TB
    A["Five Core Principles<br/>for Early Users"] --> B["💰 Charge Real Money Early"]
    A --> C["🎯 Employ Targeted,<br/>Personal Outreach"]
    A --> D["🚀 Launch Early &<br/>Engineer Serendipity"]
    A --> E["🔬 Study Users Like<br/>an Anthropologist"]
    A --> F["⚡ Experiment Fast &<br/>Don't Fear Churn"]
    
    B --> B1["Sharper Feedback<br/>from Paying Customers"]
    C --> C1["High Signal vs<br/>Noisy Broadcast"]
    D --> D1["Wide Surface Area<br/>for Discovery"]
    E --> E1["Deep Empathy &<br/>Insight"]
    F --> F1["Rapid Learning &<br/>Evolution"]
```
...
```mermaid
graph LR
    A["Search Algorithm:<br/>Find people crazy enough<br/>to buy a $150k car with<br/>limited range, cargo,<br/>charging, & weird styling"] 
    A --> B["Early Adopter Filter:<br/>Tech enthusiasts &<br/>performance fanatics"]
    B --> C["Influence on Product DNA:<br/>Prioritized acceleration<br/>& technology over<br/>comfort & practicality"]
    C --> D["Long-term Evolution:<br/>Model Y has<br/>Lamborghini-level 0-60<br/>but Toyota-level suspension"]
    
    D --> E["The 'So What?':<br/>Not an accident—<br/>outcome of the<br/>search algorithm"]
```
...
```mermaid
graph TB
    subgraph CONSUMER["🏠 CONSUMER MARKET"]
        C1["Average Personal<br/>Software Spend:<br/>~$150/month"]
        C2["Challenges:<br/>• Tiny budget<br/>• Ad revenue ≠ AI costs<br/>• Subscription fatigue<br/>• Competitive squeeze"]
    end
    
    subgraph BUSINESS["💼 BUSINESS MARKET"]
        B1["Corporate Software Spend:<br/>Much larger per tool<br/>Multiple tools per company"]
        B2["Advantages:<br/>• Budgets for solutions<br/>• Price-insensitive<br/>• Faster decision-making<br/>• Higher LTV"]
    end
    
    CONSUMER --> RESULT1["❌ Uphill battle<br/>for new products"]
    BUSINESS --> RESULT2["✅ Natural fit for<br/>startups"]
```
...
```mermaid
graph TB
    A["SEARCH<br/>Mindset"] --> B["Find Specific<br/>Archetypes"]
    B --> C["Enthusiasts &<br/>Users with<br/>Burning Problems"]
    C --> D["Target: B2B<br/>or Prosumer<br/>Markets"]
    
    D --> E["ENGAGE<br/>with 5 Core<br/>Principles"]
    E --> F["• Charge real money<br/>• Personal outreach<br/>• Launch early<br/>• Deep learning<br/>• Fast experiments"]
    
    F --> G["EVOLVE<br/>Path-Dependent<br/>Evolution"]
    G --> H["First users shape<br/>long-term product<br/>DNA"]
    
    H --> I["BUILD<br/>the Future<br/>with Users"]
    I --> J["Co-create with<br/>early adopters as<br/>product team members"]
```
