...
authorImage: 'https://arxiv.org/html/2507.20534v1'
...
![Refer to caption](https://arxiv.org/html/2507.20534v1/x4.png)
*Left: Attention logits explosion during mid-scale training. Right: MuonClip effectively regulates logits throughout Kimi K2's training. Source: Kimi K2 Technical Report*
...
![Refer to caption](https://arxiv.org/html/2507.20534v1/x5.png)
*Per-step training loss curve showing remarkably stable training throughout the entire process. Source: Kimi K2 Technical Report*
...
![Refer to caption](https://arxiv.org/html/2507.20534v1/x10.png)
*Data synthesis pipeline for tool use, showing the systematic approach to generating high-quality training data. Source: Kimi K2 Technical Report*
...
![Refer to caption](https://arxiv.org/html/2507.20534v1/x7.png)
...
![Refer to caption](https://arxiv.org/html/2507.20534v1/x9.png)
